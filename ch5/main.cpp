...
check_properties ()
{
  ...
  assert (is_guess_correct ('l', std::variant<Card, Joker> (Card{ FaceValue (9), Suit::Clubs }),
                            std::variant<Card, Joker> (Card{ FaceValue (6), Suit::Clubs })));
  assert (is_guess_correct ('l', std::variant<Card, Joker> (Joker{}),
                            std::variant<Card, Joker> (Card{ FaceValue (6), Suit::Clubs })));
  assert (is_guess_correct ('l', std::variant<Card, Joker> (Card{ FaceValue (6), Suit::Clubs }),
                            std::variant<Card, Joker> (Joker{})));
  assert (is_guess_correct ('l', std::variant<Card, Joker> (Joker{}), std::variant<Card, Joker> (Joker{})));
}
